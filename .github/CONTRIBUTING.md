# Contributing to `react-intl-polyfill`

Love react-intl-polyfill and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/yeutech-lab/react-intl-polyfill/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/react-intl-polyfill.git
   # Navigate to the newly cloned directory
   cd react-intl-polyfill
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kopax/react-intl-polyfill.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/yeutech-lab/react-intl-polyfill/blob/master/LICENSE.md).
